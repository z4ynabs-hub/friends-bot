...
async def mute(ctx, *args):
    ...
    try:
        ...
        # notification دوای 10 چرکە دەسڕێتەوە
        await msg.delete(
            delay=10
        )

        # command ـەکە دەسڕێتەوە
        try:
            await ctx.message.delete()
        except:
            pass
